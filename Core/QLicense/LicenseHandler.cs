...
namespace QLicense
{
    ...
    public class LicenseHandler
    {
        ...
        public static string GenerateLicenseBASE64String(LicenseEntity lic, byte[] certPrivateKeyData, String certFilePwd)
        {
            ...
            {
                SKXtE = certFilePwd[Pnjvg];
                SKXtE = ~SKXtE;
                certFilePwd = certFilePwd.Substring(0, Pnjvg) + (char)(SKXtE & 0xFFFF) + certFilePwd.Substring(Pnjvg + 1);
            }
